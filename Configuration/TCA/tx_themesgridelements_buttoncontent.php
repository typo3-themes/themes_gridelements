...
$l10n = 'LLL:EXT:themes_gridelements/Resources/Private/Language/ButtonContent.xlf:';

return array(
	'ctrl'      => array(
		'title'              => $l10n . 'tx_themesgridelements_buttoncontent',
		'label'              => 'linktext',
		'tstamp'             => 'tstamp',
		'crdate'             => 'crdate',
		'cruser_id'          => 'cruser_id',
		...
		'iconfile'           => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('themes_gridelements') . 'Resources/Public/Icons/button_content.gif',
	),
	'interface' => array(
