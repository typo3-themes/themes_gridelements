...
// Column settings
$tempColumn = ['tx_themes_enforceequalcolumnheight' => ['displayCond' => ['AND' => ['FIELD:CType:=:gridelements_pi1', 'OR' => ['FIELD:tx_gridelements_backend_layout:=:row', 'FIELD:tx_gridelements_backend_layout:=:column']]], 'exclude' => 1, 'label' => 'LLL:EXT:themes/Resources/Private/Language/locallang.xlf:enforce_equal_column_height', 'config' => ['type' => 'input', 'renderType' => 'ThemesContentEnforceEqualColumnHeight']], 'tx_themes_columnsettings' => ['displayCond' => ['AND' => ['FIELD:CType:=:gridelements_pi1', 'OR' => ['FIELD:tx_gridelements_backend_layout:=:singleColumn', 'FIELD:tx_gridelements_backend_layout:=:singleColumnHorizontal']]], 'exclude' => 1, 'label' => 'LLL:EXT:themes/Resources/Private/Language/locallang.xlf:column_settings', 'config' => ['type' => 'input', 'renderType' => 'ThemesContentColumnSettings']]];
