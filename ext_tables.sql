#
# Table structure for table 'tx_themesgridelements_buttoncontent'
#
CREATE TABLE tx_themesgridelements_buttoncontent (
...
CREATE TABLE tt_content (
	tx_themesgridelements_buttoncontent int(11) DEFAULT '0' NOT NULL,
);